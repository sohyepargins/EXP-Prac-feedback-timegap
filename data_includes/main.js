...
Template( "pracshort.csv", row =>
    newTrial("experiment",
        ...
        newKey("FJ")
            ...
            .failure( newText("No, that's incorrect").print() )
        ,
        getVar("RT").set(v=>Date.now()-v),
        newText("RTdisplay").text(getVar("RT")),
        newText("You took ").after(getText("RTdisplay").after(newText("ms to make your choice"))).print()
        ,
         newTimer(800)
            .start()
            .wait()
